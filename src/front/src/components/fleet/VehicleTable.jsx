              ...
              <tr key={vehicle.id}>
                ...
                <td>
                  <div className="table-actions">
                    <Link aria-label={`Visualizar ${vehicle.model}`} className="icon-button" to={`/frota/${vehicle.id}`}>
                      <Icon name="eye" />
                    </Link>
                    <Link aria-label={`Editar ${vehicle.model}`} className="icon-button" to={`/frota/novo`}>
                      <Icon name="edit" />
                    </Link>
                  </div>
                </td>
      ...
      <div className="vehicle-card-list">
        {vehicles.map((vehicle) => (
          <article className="vehicle-card" key={vehicle.id}>
            ...
            <div className="table-actions">
              <Link className="icon-button icon-button--label" to={`/frota/${vehicle.id}`}>
                <Icon name="eye" />
                <span>Detalhes</span>
              </Link>
              <Link className="icon-button icon-button--label" to="/frota/novo">
                <Icon name="edit" />
                <span>Editar</span>
              </Link>
            </div>
